...
<head>
    ...
    <title>iOS/Android App Development CTA Form</title>
...
<body>
    <div class="app-cta-container">
        ...
        <form id="app-cta-form">
            <div class="input-group">
                <input type="text" class="app-cta-input" id="app-name" placeholder=" " required>
                <label for="app-name">Your Name</label>
            </div>
            <div class="input-group">
                <input type="email" class="app-cta-input" id="app-email" placeholder=" " required>
                <label for="app-email">Your Email</label>
            </div>
            <div class="input-group">
                <input type="tel" class="app-cta-input" id="app-phone" placeholder=" " required>
                <label for="app-phone">Your Phone Number</label>
            </div>
            <div class="input-group">
                <input type="url" class="app-cta-input" id="app-existing" placeholder=" ">
                <label for="app-existing">Existing App (if any)</label>
            </div>
            <div class="input-group">
                <input type="text" class="app-cta-input" id="app-budget" placeholder=" " required>
                <label for="app-budget">Your Development Budget</label>
            </div>
            <div class="input-group">
                <textarea class="app-cta-input" id="app-requirements" placeholder=" "></textarea>
                <label for="app-requirements">App Features & Goals</label>
            </div>
            <div class="input-group">
                <select class="app-cta-select" id="app-platform">
...
</html><?php /**PATH F:\xampp\htdocs\itsoftexpert\resources\views/ios-android-form.blade.php ENDPATH**/ ?>