...
<body>
    <div class="workflow-cta-container">
        ...
        <form id="workflow-cta-form" method="post" action="<?php echo e(url('/query')); ?>">    
        <?php echo csrf_field(); ?>        
...
</html><?php /**PATH F:\xampp\htdocs\itsoftexpert\resources\views/workflow-automation-form.blade.php ENDPATH**/ ?>