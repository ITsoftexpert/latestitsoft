...
<body>
    <div class="content-cta-container">
        ...
        <form id="content-cta-form" method="post" action="<?php echo e(url('/query')); ?>">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH F:\xampp\htdocs\itsoftexpert\resources\views/content-marketing-form.blade.php ENDPATH**/ ?>