<?php $__env->startSection('section'); ?>
    ...
    <div class="loader">
        <video autoplay muted playsinline onended="hideLoader()">
    ...
    <!-- <header id="main-header">
        <div class="header-container">
            <div class="logo">
                <a href="/"><img src="assest/logos/logo-white.webp" alt="Logo"></a>
            </div>
            <div id="mobile-logo">
            ...
            <ul class="nav-menu">
                <li class="dropdown services">
                    <a id="tb" href="service">Services <i class="fa-solid fa-caret-down"></i></a>
                    <div class="mega-menu">
                ...
                <li><a id="tb" href="Blog">Blog</a></li>
                ...
                <div class="views1-section">
                    ...
                    <!-- <div class="Box_review_section">
                        <div class="google-reviews-sectionv3s">
                            ...
                            <div>
                                <p class="v1s-text">ITsoftexpert.com is rated great</p>
                                <p class="reviews-rating-no"><strong></strong>@ITsoftexpert01</p>
                                <p class="pink-stars">5.0 Reviews</p><i class="fa-solid fa-comment"></i> 29 | <i
                                    class="fa-solid fa-star"></i> 7.0 | <i class="fa-solid fa-circle-check"></i> 91%</p>
                            </div>
                        </div>
                    </div> -->
                </div>
                        ...
                        <div id="s3-cards">
                            ...
                            <div id="s3-card3">
                                <div id="s3-card-top">
                                    ...
                                    <p>We create performance websites that align perfectly with your business
                                        goals.
                    ...
                    <div class="testimonials-section">
                        <div class="testimonials-container">
                            ...
                            <div class="testimonial-card">
                                <h3>johnny brownlee</h3>
                                <p>I cannot praise this developer enough for their outstanding work. Their
                                    professionalism, technical expertise, and
                                    commitment to delivering a high-quality solution have left a lasting impression. I
                                    wholeheartedly recommend them to
                                    anyone in need of a skilled developer who can tackle complex projects with
                            ...
                            <div class="testimonial-card">
                                <h3>keval kant</h3>
                                <p>IT Softexpert is top-tier when it comes to web development. Their team is packed with
                                    experts who really know their
                                    stuff. They are super professional, responsive, and always deliver high quality
                                    results on time. IT Softexpert stands
                                    out as a highly recommended partner for web development needs.</p>
                            </div>
                        </div>
                    </div>
                </section>
...
<?php echo $__env->make('layout/structure', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\itsoftexpert\resources\views/index.blade.php ENDPATH**/ ?>