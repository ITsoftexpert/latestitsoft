...
<?php $__env->startSection('section'); ?>
    ...
    <div class=" banner-section-serc-page">
        <div class="cta-section-service-page">
            ...
            Our Expertise in Crafting Innovative Digital Solutions
            </h1>
            <p class="v3s-parag0apg">We provide innovative IT solutions that elevate your business. Explore our portfolio to see how we drive success with custom digital products.</p>
            <div class="btn-service-banner">
                <a href="/#" class="cta-button">Let’s Build Something Amazing Together</a>
            </div>
            <p class="v3s-parag0apg">Get in touch with us today to discuss how we can turn your ideas into reality.
            </p>
        </div>
    </div>
    ...
    <div class="services-page-cards">
        <div class="views3-section">
            <h2 class="v3s-heading">Our Valued 
                <span style="color: #03a4e3;">Partners</span>
            </h2>
            <p class="v3s-parag0apg">We take pride in partnering with top companies to deliver exceptional results and drive success.</p>
        </div>
...
<?php echo $__env->make('layout/structure', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\itsoftexpert\itsoftexpert\resources\views/testimonials.blade.php ENDPATH**/ ?>