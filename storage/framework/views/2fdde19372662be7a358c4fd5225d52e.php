<?php $__env->startSection('section'); ?>
    ...
    <div class=" banner-section-serc-page">
        <div class="cta-section-service-page">
            <h1 class="cta-heading">
                Insights & Inspiration: Explore Our Latest Blogs
            </h1>
            <p class="v3s-parag0apg">Welcome to our blog, your go-to source for the latest trends, expert tips, and
                industry insights. Stay informed and inspired with fresh, valuable content.</p>
            <div class="btn-service-banner">
                <a href="/#" class="cta-button">Browse Our Latest Articles Now.</a>
            </div>
            <p class="v3s-parag0apg">Discover new ideas, strategies, and updates that help you grow and stay ahead.
    ...
    <div id="s1-img-container">
        <div id="image-left">
            <img src="assest/funnel-img/29.png" alt="">
        </div>
        <div id="image-right">
            <img src="assest/funnel-img/27.png" alt="">
        </div>
    </div>

    <h2 id="blog-heading">How We <span style="color: #03a4e3;">Drive Revenue</span></h2>
    ...
    <div class="blog-container">
        ...
        <div class="blog-card">
            ...
            <div class="blog-card-content">
                <h2>Digital Marketing Institute at ItsoftExpert</h2>
                <p>In this fast-evolving landscape, digital marketing has become an essential skill.</p>
                <a href="/Digital Marketing Institute at ItsoftExpert">Read More →</a>
            </div>
        </div>
        ...
        <div class="blog-card">
            ...
            <div class="blog-card-content">
                ...
                <p>Is establishing a prosperous career in digital marketing your goal? Want to upskill?</p>
                <a href="/Live Project Training">Read More →</a>
            </div>
        </div>
        <div class="blog-card">
            <img src="assest/funnel-img/blog_img/3.webp" alt="Blog Image">
            <div class="blog-card-content">
                <h2>Google’s August 2024 Core Algorithm Update</h2>
                <p>Google’s eagerly anticipated August 2024 Core Update was made available on August 15.</p>
                <a href="/Digital Marketing Institute at ItsoftExpert">Read More →</a>
            </div>
        </div>
...
<?php echo $__env->make('layout/structure', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\itsoftexpert\itsoftexpert\resources\views/Blog.blade.php ENDPATH**/ ?>