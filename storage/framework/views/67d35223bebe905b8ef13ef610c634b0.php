...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/forhomeonly.css')); ?>">
...
<body>
    ...
    <div id="loader">
        <video id="loaderVideo" autoplay loop muted playsinline>
            <source src="<?php echo e(asset('media/Mark2_3.mp4')); ?>" type="video/mp4">
                        ...
                        <div class="testimonials-container">
                            <div class="testimonial-card video-card">
                                <video id="testimonial-vid" muted loop controls
                                    src="<?php echo e(asset('media/testimonials-video-luey.mp4')); ?>"></video>
                            ...
                            <div class="testimonial-card video-card">
                                <video id="testimonial-vid" muted loop controls
                                    src="<?php echo e(asset('media/IT-Softexpert-reviews-digital-marketing.mp4')); ?>"></video>
                                <div class="stars">
                                    <i class="fa-sharp fa-solid fa-star fa-beat fa-xs" style="color: #FFD43B;"></i>
                                    <i class="fa-sharp fa-solid fa-star fa-beat fa-xs" style="color: #FFD43B;"></i>
                                    <i class="fa-sharp fa-solid fa-star fa-beat fa-xs" style="color: #FFD43B;"></i>
...
<?php /**PATH C:\xampp\htdocs\itsoftexpert\resources\views/index.blade.php ENDPATH**/ ?>