...
<body>
    <div class="contact-cta-container">
        ...
        <form id="contact-cta-form"  method="post" action="<?php echo e(url('/query')); ?>">    
        <?php echo csrf_field(); ?>        
            ...
            <div class="input-group">
                <input type="hidden" class="contact-cta-input" name="form_type" placeholder="" required>                
            </div>
...
</html><?php /**PATH F:\xampp\htdocs\itsoftexpert\resources\views/connect-with-itsoftexpert.blade.php ENDPATH**/ ?>